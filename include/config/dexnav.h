...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x267 // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x266 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x268 // Allow player to find hidden mons
