...
void ItemUseCB_IncreaseIV(u8 taskId, TaskFunc task)
{
    ...
    case STAT_HP:
        ...
        {
            modifier = (health <= (MAX_PER_STAT_IVS - 7)) ? (health + 7) : MAX_PER_STAT_IVS;
            SetMonData(mon, MON_DATA_HP_IV, &modifier);
            StringCopy(gStringVar2, gText_HP3);
            didActivate = TRUE;
        }
    ...
    case STAT_ATK:
        ...
        {
            modifier = (attack <= (MAX_PER_STAT_IVS - 7)) ? (attack + 7) : MAX_PER_STAT_IVS;
            SetMonData(mon, MON_DATA_ATK_IV, &modifier);
            StringCopy(gStringVar2, gText_Attack3);
            didActivate = TRUE;
        }
    ...
    case STAT_DEF:
        ...
        {
            modifier = (defense <= (MAX_PER_STAT_IVS - 7)) ? (defense + 7) : MAX_PER_STAT_IVS;
            SetMonData(mon, MON_DATA_DEF_IV, &modifier);
            StringCopy(gStringVar2, gText_Defense3);
            didActivate = TRUE;
        }
    ...
    case STAT_SPEED:
        ...
        {
            modifier = (speed <= (MAX_PER_STAT_IVS - 7)) ? (speed + 7) : MAX_PER_STAT_IVS;
            SetMonData(mon, MON_DATA_SPEED_IV, &modifier);
            StringCopy(gStringVar2, gText_Speed2);
            didActivate = TRUE;
        }
    ...
    case STAT_SPATK:
        ...
        {
            modifier = (spAttack <= (MAX_PER_STAT_IVS - 7)) ? (spAttack + 7) : MAX_PER_STAT_IVS;
            SetMonData(mon, MON_DATA_SPATK_IV, &modifier);
            StringCopy(gStringVar2, gText_SpAtk3);
            didActivate = TRUE;
        }
    ...
    case STAT_SPDEF:
        ...
        {
            modifier = (spDefense <= (MAX_PER_STAT_IVS - 7)) ? (spDefense + 7) : MAX_PER_STAT_IVS;
            SetMonData(mon, MON_DATA_SPDEF_IV, &modifier);
            StringCopy(gStringVar2, gText_SpDef3);
            didActivate = TRUE;
        }
