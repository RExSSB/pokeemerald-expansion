...
const u32 gItemIcon_SluggishCandy[] = INCBIN_U32("graphics/items/icons/question_mark.4bpp.lz");
const u16 gItemIconPalette_SluggishCandy[] = INCBIN_U16("graphics/items/icon_palettes/question_mark.gbapal");
