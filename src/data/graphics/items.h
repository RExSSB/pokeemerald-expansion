...
const u32 gItemIcon_TopHat[] = INCBIN_U32("graphics/items/icons/top_hat.4bpp.lz");
const u16 gItemIconPalette_TopHat[] = INCBIN_U16("graphics/items/icon_palettes/top_hat.gbapal");
