...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_TOP_FOURTH]       = {SPECIES_GYARADOS, 50, ITEM_NONE, BALL_POKE, NUM_NATURES, NUM_ABILITY_SLOTS, MON_GENDERLESS, {0,0,0,0,0,0}, {USE_RANDOM_IVS,USE_RANDOM_IVS,USE_RANDOM_IVS,USE_RANDOM_IVS,USE_RANDOM_IVS,USE_RANDOM_IVS}},
